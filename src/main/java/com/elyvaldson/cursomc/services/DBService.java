...
import com.elyvaldson.cursomc.domain.Cidade;
import com.elyvaldson.cursomc.domain.Cliente;
import com.elyvaldson.cursomc.domain.Endereco;
import com.elyvaldson.cursomc.domain.Estado;
import com.elyvaldson.cursomc.domain.ItemPedido;
import com.elyvaldson.cursomc.domain.Pagamento;
import com.elyvaldson.cursomc.domain.PagamentoComBoleto;
import com.elyvaldson.cursomc.domain.PagamentoComCartao;
import com.elyvaldson.cursomc.domain.Pedido;
import com.elyvaldson.cursomc.domain.Produto;
import com.elyvaldson.cursomc.domain.enums.EstadoPagamento;
import com.elyvaldson.cursomc.domain.enums.Perfil;
import com.elyvaldson.cursomc.domain.enums.TipoCliente;
import com.elyvaldson.cursomc.repositories.CategoriaRepository;
import com.elyvaldson.cursomc.repositories.CidadeRepository;
import com.elyvaldson.cursomc.repositories.ClienteRepository;
import com.elyvaldson.cursomc.repositories.EnderecoRepository;
import com.elyvaldson.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cli2.getTelefones().addAll(Arrays.asList("32326589", "98359398"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38415012", cli2, c2);
